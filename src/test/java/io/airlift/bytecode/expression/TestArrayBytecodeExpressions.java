...
import static io.airlift.bytecode.expression.BytecodeExpressionAssertions.assertBytecodeExpressionType;
...
public class TestArrayBytecodeExpressions
{
    ...
    private final ClassDefinition classDefinition = new ClassDefinition(a(PUBLIC, FINAL), "DummyClass", type(Object.class));
    private final Map<Class<?>, MethodDefinition> typeMethodMap = new HashMap<>();

    TestArrayBytecodeExpressions()
    {
            ...
            throws Exception
    {
        ...
        assertBytecodeExpressionType(newArray(type(String[].class), ImmutableList.of(constantString("grape"), constantNull(String.class), constantString("new"), constantString("array"))), type(String[].class));
        assertBytecodeExpression(
                newArray(type(String[].class), ImmutableList.of(constantString("grape"), constantNull(String.class), constantString("new"), constantString("array"))),
                new String[] {"grape", null, "new", "array"},
                "new String[] {\"grape\", null, \"new\", \"array\"}");
    }
    ...
    private MethodDefinition defineSetAndGetMethod(Class<?> aClass)
    {
